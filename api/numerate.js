...
var sentence = "who are you?"
 
  var i = 2508;
  setInterval(function() {
    console.log(i)
    var json = require("fs").readFileSync("./api/wik.json", "utf8");
    var json = JSON.parse(json);
    var page = json[i].page;
    var wordcount = page.split(" ").length;
    ...
    function count(sentence) {
      ...
      for (var i = 0; i < list.length; i++) {
        ...
        if (words.hasOwnProperty(word)) {
          ...
          var threshold = .00010* wordcount
          if (one >= threshold ){
            words[word] = {
            count: one,
            word: word,
            index: numerate(word),
              threshold:100 * one / wordcount
          }; }
          else
          {
            words[word] = {
    ...
    if (data.indexOf(title) == -1) {
      //console.log(page);
      var obj = { page: page, title: title };
      var json = require("fs").readFileSync("./api/parsed.json", "utf8");
  ...
  window.URL.revokeObjectURL(url);*/
      ...
      mainmenu: function mainmenu(e) {
        modalContent.innerHTML =
          "<div class='row'><ul><div class='column'><li><a href='#dashboard'><h2>Dashboard</h2><p>Open your account dashboard</p></a></li></div><div class='column'><li><a href='#docs'><h2>Documentation</h2><p>Get answers and instructions</p></a></li></div><div class='column'><li><a href='#pro'><h2>Go Pro!</h2><p>Upgrade your Fastur account</p></a></li></div><div class='column'><li><a href='#contact'><h2>Contact</h2><p>Send your questions and comments</p></a></li></div><div class='column'><li><a href='#login'><h2>Log In</h2><p>Log in to your account</p></a></li></div><div class='column'><li><a href='#register'><h2>Register</h2><p>Create a new account</p></a></li></div></ul></div>";
      ...
      login: function login(e, a, o, u, s, b) {
        ...
        fetch("/", {
          ...
          reader.read().then(function processResult(result) {
            ...
            if (result.type == "dict") {
            var container =  document.getElementById('uform-li')
...
.btn.active {
 ...
 /* change position of the button, e.g. set top:0 to bottom:0 OR from top:0 to top:50% */
 right: 0;
 top: 0;

 /* depending on the location of the button, you have to adjust the border-radius of the button */
